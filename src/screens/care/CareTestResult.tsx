	...
	return(
		<>
			...
			>
				...
				<View style={[GLOBAL_STYLES.screenContainer, {position: 'absolute', bottom: '10%'}]}>

					<Text style={[GLOBAL_STYLES.p, {marginBottom:20}]}>
						Los resultados de esta evaluación nos ayudan a brindarte un plan balanceado de bienestar y a asignarte uno de los pilares del modelo C.A.R.E. que trabajarás cada mes.
					</Text>
